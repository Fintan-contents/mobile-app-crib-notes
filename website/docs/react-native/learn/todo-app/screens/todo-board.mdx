...
:::info
`toggleTodoCompletion`では**[関数型の更新](https://ja.reactjs.org/docs/hooks-reference.html#functional-updates)**を利用しています。
[React公式ドキュメント](https://ja.reactjs.org/docs/faq-state.html#what-is-the-difference-between-passing-an-object-or-a-function-in-setstate)も参照してみてください。
:::
