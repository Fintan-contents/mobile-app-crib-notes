...
:::info
2021-12-01時点では、`npm run ios`を実行すると以下のような警告ログが出力されてしまいます。起動に影響はないので無視してください。
...
ログの最後に次のように「Successfully launched the app」が出力されていれば、問題ありません。

```console
info Installing "/Users/<username>/Library/Developer/Xcode/DerivedData/HandsOnApp-fvysoqvesrnotndxtrkjefuwnhbo/Build/Products/Debug-iphonesimulator/HandsOnApp.app"
