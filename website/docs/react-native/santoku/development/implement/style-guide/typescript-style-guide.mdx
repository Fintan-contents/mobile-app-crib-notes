...
### 実装ガイドのアプリケーション構造に従ったディレクトリ構成にしてください

<!-- TODO: 機能レイヤー、機能モジュール、ステレオタイプのドキュメントができたら、そのドキュメントへのリンクを追加する -->
実装ガイドのアプリケーション構造に定義されている以下の3つに従って、ディレクトリを構成してください。
...
定数とは、ステレオタイプの`Constant`に該当するものです。
