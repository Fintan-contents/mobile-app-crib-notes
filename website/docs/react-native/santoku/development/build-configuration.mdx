...
しかしアプリによっては、Expo configで指定可能な設定以外にも変更したい設定値が存在するケースもあります。
...
to: '/react-native/santoku/development/build-configuration/order-plugins',
summary: <>各Config Pluginが実行される順序と注意点を記載しています。</>
},
{
title: 'ビルドタイプ',
...
summary: <>環境の切り替えや、ビルドタイプに応じたアプリのインストールや起動方法について詳細なコマンドを記載しています。</>
},
{
