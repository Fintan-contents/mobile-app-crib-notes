...
過去のバージョンのXcodeは、[Downloads - Apple Developer](https://developer.apple.com/download/all/?q=xcode)からダウンロードできます。ただし、Xcodeの過去バージョンをダウンロードするには、無償のデベロッパアカウントが必要です。デベロッパアカウントを作成してあるApple IDでログインしてからダウンロードしてください。
