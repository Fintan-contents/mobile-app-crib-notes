...
プッシュ通知やディープリンクなど、[Appの高度な機能](https://developer.apple.com/jp/help/account/reference/supported-capabilities-ios)をデバイスで動かすには無償のデベロッパアカウントではなく、Apple Developer (Enterprise) Programのライセンスが必要になります。
