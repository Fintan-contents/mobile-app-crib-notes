...
export const useModalContainer = ({
  ...
  }, [afterSlideIn, clock, setModalIsVisible, slideInConfig, slideInDuration]);
  ...
  }, [afterSlideOut, clock, setModalInvisible, slideOutConfig, slideOutDuration]);
  ...
  return {isModalVisible, transform, updateContentHeight};
};
