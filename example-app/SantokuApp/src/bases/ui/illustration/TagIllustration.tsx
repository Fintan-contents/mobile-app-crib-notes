...
export type TagIllustrationProps = StyledSvgIconBaseProps & ColorProps<RestyleTheme>;

export const TagIllustration = ({color = 'black', size = 'p24', ...rest}: TagIllustrationProps) => {
