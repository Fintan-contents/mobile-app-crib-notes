...
export type MoreVertIllustrationProps = StyledSvgIconBaseProps & ColorProps<RestyleTheme>;

export const MoreVertIllustration = ({color = 'black2', size = 'p24', ...rest}: MoreVertIllustrationProps) => {
