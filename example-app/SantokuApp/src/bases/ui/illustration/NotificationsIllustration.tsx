...
export type NotificationsIllustrationProps = StyledSvgIconBaseProps & ColorProps<RestyleTheme>;

export const NotificationsIllustration = ({color = 'grey3', size = 'p24', ...rest}: NotificationsIllustrationProps) => {
