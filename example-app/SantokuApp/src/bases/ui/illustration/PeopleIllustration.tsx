...
export type PeopleIllustrationProps = StyledSvgIconBaseProps & ColorProps<RestyleTheme>;

export const PeopleIllustration = ({color = 'white', size = 'p24', ...rest}: PeopleIllustrationProps) => {
