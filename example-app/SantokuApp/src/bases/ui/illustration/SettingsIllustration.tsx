...
export type SettingsIllustrationProps = StyledSvgIconBaseProps & ColorProps<RestyleTheme>;

export const SettingsIllustration = ({color = 'grey3', size = 'p24', ...rest}: SettingsIllustrationProps) => {
