...
export type PostSignupMutationResult = NonNullable<AsyncReturnType<typeof postSignup>>;
...
export type PostLoginMutationResult = NonNullable<AsyncReturnType<typeof postLogin>>;
...
export type PostLogoutMutationResult = NonNullable<AsyncReturnType<typeof postLogout>>;
...
export type GetAccountsAccountIdQueryResult = NonNullable<AsyncReturnType<typeof getAccountsAccountId>>;
...
export type GetAccountsAccountIdAvatarQueryResult = NonNullable<AsyncReturnType<typeof getAccountsAccountIdAvatar>>;
...
export type GetAccountsMeQueryResult = NonNullable<AsyncReturnType<typeof getAccountsMe>>;
...
export type GetAccountsMeAvatarQueryResult = NonNullable<AsyncReturnType<typeof getAccountsMeAvatar>>;
...
export type PutAccountsMeAvatarMutationResult = NonNullable<AsyncReturnType<typeof putAccountsMeAvatar>>;
...
export type PostAccountsMeDeviceTokenMutationResult = NonNullable<AsyncReturnType<typeof postAccountsMeDeviceToken>>;
...
export type GetAccountsMeTermsQueryResult = NonNullable<AsyncReturnType<typeof getAccountsMeTerms>>;
...
export type PostAccountsMeTermsMutationResult = NonNullable<AsyncReturnType<typeof postAccountsMeTerms>>;
...
export type DeleteAccountsMeDeleteMutationResult = NonNullable<AsyncReturnType<typeof deleteAccountsMeDelete>>;
