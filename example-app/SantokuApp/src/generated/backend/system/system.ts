...
export type GetCsrfTokenQueryResult = NonNullable<AsyncReturnType<typeof getCsrfToken>>;
...
export type GetAppUpdatesQueryResult = NonNullable<AsyncReturnType<typeof getAppUpdates>>;
