...
export const listTodo = (params?: ListTodoParams, signal?: AbortSignal) => {
  return sandboxCustomInstance<ListTodoResponse>({url: `/todos`, method: 'get', signal, params});
};
...
export const useListTodo = <TData = Awaited<ReturnType<typeof listTodo>>, TError = ErrorType<BadRequestResponse>>(
  ...
  const query = useQuery<Awaited<ReturnType<typeof listTodo>>, TError, TData>(queryKey, queryFn, queryOptions);
 ...
 */
export const listTodoByCursor = (params?: ListTodoByCursorParams, signal?: AbortSignal) => {
  return sandboxCustomInstance<ListTodoInfiniteResponse>({url: `/todos/infinite`, method: 'get', signal, params});
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listTodoByCursor>>> = ({signal, pageParam}) =>
    listTodoByCursor({cursor: pageParam, ...params}, signal);
