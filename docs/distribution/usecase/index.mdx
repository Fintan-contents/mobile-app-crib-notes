...
- [ADP・ADEPのAdHocでインストールする](../ios-ad-hoc.md)
...
|ユースケース/配布|[個人でUSB経由](../ios-developer-account.md)|[AdHoc](../ios-ad-hoc.md)|[In-House](../ios-in-house.md)|[TestFlight(内部)](../ios-testflight.md)|[TestFlight(外部)](../ios-testflight.md)|
|:---------|-:-|-:-|-:-|:--|:--|
