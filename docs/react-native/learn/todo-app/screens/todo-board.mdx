...
:::info
`toggleTodoCompletion`では**[関数型の更新](https://ja.reactjs.org/docs/hooks-reference.html#functional-updates)**を利用しています。利用している理由については
[演習課題](./exercise.mdx#実装の注意点と不具合の確認)を用意しています。
:::
