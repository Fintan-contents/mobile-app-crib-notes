...
![TabNavigation](tab_navigation.png)
...
import {AuthedRootStackParamList, MainTabParamList, RootStackParamList, TodoStackParamList} from 'navigation/types';
...
type TodoStackNavigationProp<T extends TodoStackParamListKeys> = CompositeNavigationProp<
  ...
  CompositeNavigationProp<
    ...
    CompositeNavigationProp<StackNavigationProp<AuthedRootStackParamList>, StackNavigationProp<RootStackParamList>>
  >
>;
